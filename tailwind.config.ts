    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            opacity: "0.55",
            boxShadow: "0 0 12px 2px hsl(var(--brand-yellow) / 0.0825), 0 0 28px 6px hsl(var(--brand-yellow) / 0.0525)",
          },
          "50%": {
            opacity: "1",
            boxShadow: "0 0 18px 4px hsl(var(--brand-yellow) / 0.1275), 0 0 44px 10px hsl(var(--brand-yellow) / 0.075)",
          },
        },
      },
      animation: {
